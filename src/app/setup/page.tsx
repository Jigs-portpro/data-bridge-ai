                ...
                <AccordionTrigger className="px-6 py-4 hover:no-underline">
                  <div className="flex items-center justify-between w-full">
                    <Input
                      ...
                      />
                    <div role="button" tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.stopPropagation(); handleRemoveEntity(entity.internalId);}}} onClick={(e) => { e.stopPropagation(); handleRemoveEntity(entity.internalId); }} className="p-1.5 rounded-md hover:bg-destructive/10 text-destructive focus:outline-none focus:ring-2 focus:ring-destructive focus:ring-offset-2 cursor-pointer">
